...
return [
    ...
    */
    ...
    'styles' => [
        ...
        'packages/bamboo/base/css/bamboo-theme.css',
        'css/style.css',
        ...
        'packages/bamboo/fontawesome/css/all.min.css',
    ...
    'project_logo' => '<b>Publi</b>media',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header navbar navbar-color bg-bamboo-primary',
    ...
    'developer_name' => 'Bamboo Coding',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'https://www.bamboo.cr',
