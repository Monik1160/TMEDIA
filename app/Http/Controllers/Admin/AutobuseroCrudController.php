...
use App\Http\Requests\AutobuseroRequest;
use App\Models\IdentificationType;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class AutobuseroCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class AutobuseroCrudController extends CrudController
{
    ...
    {
        $this->crud->setModel('App\Models\Autobusero');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/autobusero');
        $this->crud->setEntityNameStrings('autobusero', 'autobuseros');
    }
...
//        $this->crud->removeButton('update');
    ...
    {
        $this->crud->setValidation(AutobuseroRequest::class);
